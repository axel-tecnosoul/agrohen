...
<html lang="en">
  <head>
    ...
    <style type="text/css">
      ...
      #dropdownPedidos > .dropdown-menu > .dropdown-item:hover{
        color: #4466f2;
      }
    </style>
  </head>
    ...
    <div class="page-body-wrapper">
      ...
      <div class="page-body">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-3 xl-30">
                ...
                <div class="row">
                  ...
                  <div class="col-xl-12">
                    <div class="card">
                      <div class="card-header">
                        <h5 class="mb-0">
                          <button class="btn btn-link pl-0 collapsed" data-toggle="collapse" data-target="#collapseicon" aria-expanded="false" aria-controls="collapseicon">Filter</button>
                        </h5>
                      </div>
                      <div class="collapse" id="collapseicon" aria-labelledby="collapseicon" data-parent="#accordion">
            ...
            <div class="col-xl-9 col-lg-9 col-md-9 xl-70">
              <div class="card">
                <div class="job-search">
                  <div class="card-body">
                    <div class="media pb-2 align-items-center">
                      <span class="pr-2 font-weight-bold">#2156</span>
                      <span class="px-2"># Asociado: Sap 1234</span>
                      <span class="lead ml-auto"><i class="fa fa-paperclip"></i></span>
                      <span class="lead px-2"><i class="fa fa-circle text-success"></i></span>
                      <span>10:59 5/6/2022</span>
                    </div>
                    <div class="media">
                      <img class="img-40 img-fluid m-r-20" src="assets/images/job-search/1.jpg" alt="">
                      <div class="media-body">
                        <h6 class="f-w-600">
                          <a href="#">AXXION - CORS San Isidro - 145125</a>
                          <div class="right-header pull-right m-t-5">

                            <div class="dropdown" id="dropdownPedidos">
                              <button class="btn bg-transparent p-0 text-muted" id="dropdownMenuButton" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i data-feather="more-vertical"></i></button><!--dropdown-toggle-->
                              <div class="dropdown-menu w-auto" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item py-2 px-3 f-14" href="#"><i class='f-16 fa fa-fw fa-edit'></i> Editar</a>
                                <a class="dropdown-item py-2 px-3 f-14" href="#"><i class='f-16 fa fa-fw fa-trash-o'></i> Eliminar</a>
                                <a class="dropdown-item py-2 px-3 f-14" href="#"><i class='f-16 fa fa-fw fa-envelope-o'></i> Enviar por mail</a>
                                <a class="dropdown-item py-2 px-3 f-14" href="#"><i class='f-16 fa fa-fw fa-print'></i> Imprimir</a>
                    ...
                    <p>
                       Cubina Daniel: Solicita la reparacion de A"A" de la gerencia de infraestructura...
                    </p>
                    <div class="media small pt-2 align-items-center text-secondary">
                      <span class="px-2">Caducidad: 2 días 10hs 30min.</span>
                      <span class="ml-auto">App Cliente: Juan Perez</span>
                    </div>
                  </div>
                </div>
              </div>
