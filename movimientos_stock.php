...
<html lang="en">
  <head>
    ...
    <title>MYLA - Movimientos Stock</title>
    <!-- Google font-->
                ...
                <div class="col">
                  <div class="page-header-left">
                    ...
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active">Movimientos Stock</li>
                    </ol>
                  </div>
                </div>
              </div>
  ...
  function cargarDataTable(fdesde, fhasta){
    ...
    tablaMovimientos= $('#tablaMovimientos').DataTable({
            "ajax": {
                "url" : "./models/administrar_movimientos_stock.php?accion=traerMovimientosFiltro&fdesde="+fdesde+"&fhasta="+fhasta,
                "dataSrc": "",
              },
            "columns":[
              {"data": "id_movimiento"},
