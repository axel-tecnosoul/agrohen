...
<html lang="en">
  <head>
    ...
    <title>MYLA - Tipo de items</title>
    <!-- Google font-->
  ...
  <body>
                ...
                <div class="col">
                  <div class="page-header-left">
                    ...
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active">Tipos de items</li>
                    </ol>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5>Administrar Tipos de items</h5>
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-hover" id="tablaTItems">
          ...
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      ...
                      <span id="id_tipo_item" class="d-none"></span>
                      ...
                      <div class="row">
                          <div class="col-lg-12">
                            <div class="form-group">
                              <label for="" class="col-form-label">Tipo de item:</label>
                              <input type="text" class="form-control" id="tItem" required>
                            </div>
                          </div>   
                      </div>              
                  </div>
    ...
    function cargarDatosComponentes(){
                ...
                $.ajax({
                    data: datosIniciales,
                    url: "./models/administrar_tipo_items.php",
                    method: "post",
                    cache: false,
                    contentType: false,
                    processData: false,
    ...
    $(document).on("click", ".btnEditar", function(){
      ...
      $(".modal-title").text("Editar tipo de item");
      $('#modalCRUD').modal('show');      
      fila = $(this).closest("tr");
      let id_tipo = fila.find('td:eq(0)').text();    

      let datosUpdate = new FormData();
      datosUpdate.append('accion', 'traerTItemUpdate');
      datosUpdate.append('id_tipo', id_tipo);
      $.ajax({
            data: datosUpdate,
            url: './models/administrar_tipo_items.php',
            method: "post",
            ...
            success: function(datosProcesados){
              ...
              $("#tItem").val(datosInput[0].tipo);
              $('#id_tipo_item').html(datosInput[0].id_tipo_item);
              accion = "updateTipoItem";
            }
          });
    ...
    $('#formTItem').submit(function(e){                         
    e.preventDefault(); //evita el comportambiento normal del submit, es decir, recarga total de la página   
    let tipoItem = $.trim($('#tItem').val());    
    
    let id_tipo = $.trim($('#id_tipo_item').html());                
        $.ajax({
          url: "models/administrar_tipo_items.php",
          type: "POST",
          datatype:"json",    
          data:  {accion: accion, id_tipo:id_tipo, tipoItem:tipoItem},  
          success: function(data) {
            tablaTItems.ajax.reload(null, false);
           }
        });             
...
$(document).on("click", ".btnBorrar", function(){
    fila = $(this);           
    let id_tipo = parseInt($(this).closest('tr').find('td:eq(0)').text());       

    swal({
                    title: "Estas seguro?",
                    text: "Una vez eliminado este tipo, no volveras a verla",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
                .then((willDelete) => {
                    if (willDelete) {
                        accion = "eliminarTipoItem";
                        $.ajax({
                                url: "models/administrar_tipo_items.php",
                                type: "POST",
                                datatype:"json",    
                                data:  {accion:accion, id_tipo:id_tipo},    
                                success: function() {
                                    tablaTItems.row(fila.parents('tr')).remove().draw();                  
                                }
                            }); 
                    } else {
