                    ...
                    <table class="table table-hover display" id="tablaVueltas">
                      ...
                      <tbody>
                        <?php foreach ($vueltas as $v): ?>
                          <tr>
                            <td><?=htmlspecialchars($v['id_vuelta'])?></td>
                            <td><?=htmlspecialchars($v['fecha_salida_formatted'] ?? $v['fecha_salida'])?></td>
                            <td class="text-right"><?=htmlspecialchars($v['km_salida'])?></td>
                            <td><?=$v['fecha_cierre_formatted'] ?? $v['fecha_cierre']?></td>
                            <td class="text-right"><?=$v['km_cierre']?></td>
                            <td><?=htmlspecialchars($v['chofer'])?></td>
                            <td><?=htmlspecialchars($v['camion'])?></td>
                            <td class="text-center"><?=htmlspecialchars($v['estado'])?></td>
                            <td class="text-center">
                              <div class="btn-group">
                                <a href="viajes.php?id_vuelta=<?=$v['id_vuelta']?>" class="btn btn-warning btn-sm" title="Viajes"><i class="fa fa-road"></i> Viajes</a>
                                <?php if ($v['estado'] === 'abierta'): ?>
                                  <a href="viajes.php?id_vuelta=<?=$v['id_vuelta']?>&accion=cerrar" class="btn btn-info btn-sm" title="Cerrar vuelta">Cerrar</a>
                                <?php endif; ?>
                                <?php $tieneLiquidacion = !empty($v['id_liquidacion']); ?>
                                <?php if ($v['estado'] === 'cerrada' && !$tieneLiquidacion): ?>
                                  <a href="liquidaciones_detalle.php?id_vuelta=<?=$v['id_vuelta']?>" class="btn btn-success btn-sm" title="Liquidar vuelta">Liquidar</a>
                                <?php endif; ?>
                                <?php if ($v['estado'] === 'liquidada' || $tieneLiquidacion): ?>
                                  <a href="liquidaciones_detalle.php?id_vuelta=<?=$v['id_vuelta']?>" class="btn btn-outline-success btn-sm" title="Ver liquidación">Ver liquidación</a>
                                <?php endif; ?>
                              </div>
                            </td>
                          </tr>
